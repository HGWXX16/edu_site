<template>
  ...
  <div class="Page Confirm">
    ...
    <div class="Finish">
      <div class="check fr">
        <el-checkbox v-model="agree">我已阅读并同意<a href="javascript:" target="_blank">《Yao学院购买协议》</a></el-checkbox>
      </div>
      <div class="clear"/>
      <div class="Main fl">
        <div class="fl">
      ...
      <a :href="'http://localhost:9110/api/trade/ali-pay/create-native/' + order.orderNo" target="_blank">
