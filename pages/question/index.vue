            ...
            <div class="js-wrap">
              ...
              <section class="fl">
                <ol class="js-tap clearfix">
                  <li class="current bg-blue"><a onclick="submitForm('addTime','order')" href="javascript:void(0)" title="最新">最新</a></li>
                  ...
                  <li>
                    ...
                    <section class="q-txt-box">
                      ...
                      <h3 class="hLh30 txtOf mt5">
                        ...
                        <span class="fsize12 c-999 vam"> <tt class="c-blue f-fM mr5">[最佳回答]</tt>
