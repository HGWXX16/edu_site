    ...
    <section class="container">
      <header class="comm-title">
        <aside class="h-r-search">
          ...
          <form class="fr" autocomplete="off" @submit.prevent="searchCourse()">
            <label class="h-r-s-box">
              <input v-model="searchObj.keyWords" type="text" placeholder="搜索课程">
        ...
        <div class="js-wrap">
          ...
          <section class="fl">
            ...
            <ol class="js-tap clearfix">
              <li :class="{'current bg-blue': $route.query.buyCountSort}">
                <a title="销量" href="javascript:void(0);" @click="searchBuyCount()">销量
                  <i>↓</i>
                </a>
              </li>
              <li :class="{'current bg-blue': $route.query.gmtCreateSort}">
                <a title="最新" href="javascript:void(0);" @click="searchGmtCreate()">最新
                  <i>↓</i>
                </a>
              </li>
              <li :class="{'current bg-blue': $route.query.priceSort}">
...
export default {
  ...
  async asyncData(page) {
    ...
    searchObj.keyWords = query.keyWords || ''
  ...
  methods: {
    ...
    searchCourse() {
      ...
      if (this.query.buyCountSort) {
        queryObj.buyCountSort = this.query.buyCountSort
      } else if (this.query.gmtCreateSort) {
        queryObj.gmtCreateSort = this.query.gmtCreateSort
      } else if (this.query.priceSort) {
        queryObj.priceSort = this.query.priceSort
